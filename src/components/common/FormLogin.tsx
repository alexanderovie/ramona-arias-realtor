                        ...
                        <div className="signin-with d-grid gap_9 mb_24">
                            <a href="#" className="tf-btn btn-border w-full">
                                <span className="d-flex align-items-center gap_12">
                                    <Image src="/assets/images/logo/facebook.svg" alt="logo" width={20} height={20} />
                            ...
                            <a href="#" className="tf-btn btn-border w-full">
                                <span className="d-flex align-items-center gap_12">
                                    <Image src="/assets/images/logo/google.svg" alt="logo" width={20} height={20} />
                            ...
                            <a href="#" className="tf-btn btn-border w-full">
                                <span className="d-flex align-items-center gap_12">
                                    <Image src="/assets/images/logo/twitter.svg" alt="logo" width={20} height={20} />
